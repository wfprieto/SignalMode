...
**Support level:** instructions-only | **Install:** manual | **Persistence:** custom-instructions | **Tested:** Yes
...
| Property | Value |
|---|---|
| Support Level | instructions-only |
| Installation | manual |
| Persistence | custom-instructions |
| Tested | Yes |

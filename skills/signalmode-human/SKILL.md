...
version: 1.0.0
description: >
  Immutable anti-AI writing hygiene rules. Removes every detectable AI writing
  tell from output: banned words, banned phrases, banned structures, banned
  punctuation. These rules do not change. Do not edit this file.
...
> **These rules are immutable. Do not edit this file.** They apply universally, regardless of personal style or context. For your personal voice and tone preferences, use `signalmode-voice` instead.

## Purpose

Remove every detectable AI writing tell from output. This skill enforces a fixed, non-negotiable ruleset covering banned words, banned phrases, banned sentence structures, banned punctuation habits, and banned formatting patterns. The goal is output that reads like a sharp, experienced person wrote it.

These rules are not a style preference. They are signal hygiene. They apply regardless of tone, context, or personal voice.
...
- **Do not edit this file.** These rules are immutable. They are not a personal style preference.
...
- For your personal voice, tone, and output structure, use `signalmode-voice`. That skill is fully customizable. This one is not.

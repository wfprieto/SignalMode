...
If you want to manually configure it without the installer, you can add the following to your global Claude Code settings (`$CLAUDE_CONFIG_DIR/settings.json`):
